          ...
          {betMode === "auto" && (
            <>
              ...
              <button
                ...
                disabled={startAutoBet}
                className={`order-last max-md:mb-2 md:order-last transition-all duration-300 ease-in-out transform flex items-center justify-center w-full mx-auto py-2.5 mt-3 rounded-[1rem] text-[0.98rem] font-semibold text-black cursor-pointer ${
                  startAutoBet
