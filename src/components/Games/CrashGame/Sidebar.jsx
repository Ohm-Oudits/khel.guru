        ...
        <div className="my-4 px-3 flex flex-col">
          ...
          {betMode === "manual" && (
            <>
              ...
              {bettingStarted && (
                <div
                  className={`order-2 max-lg:mb-4 md:order-20 transition-all duration-300 ease-in-out transform active:scale-90 flex items-center justify-center w-full mx-auto py-1.5 mt-3 max-lg:mt-4 rounded text-lg font-semibold bg-button-primary text-black cursor-pointer`}
              ...
              {!bettingStarted && (
                <div
                  className={`order-2 max-md:mb-4 md:order-20 transition-all duration-300 ease-in-out transform active:scale-90 flex items-center justify-center w-full mx-auto py-1.5 mt-3 max-lg:mt-4 rounded text-lg font-semibold ${
                    disableBet ? "bg-primary text-white" : "bg-button-primary"
                  } text-black cursor-pointer`}
                  onClick={handleBetClick}
                >
                  {disableBet ? "Waiting" : "Bet"}
                </div>
              )}
            </>
          )}
            ...
            <>
              ...
              <div className="w-full mb-1 order-10 md:order-2">
                ...
                <input
                  ...
                  min="1.01"
                  step="0.01"
                  onChange={(e) => setAutoMultipyTarget(e.target.value)}
                  className="w-full mt-2 h-full rounded bg-secondry outline-none text-white px-2 pr-6 py-2 border border-input hover:border-primary-4"
                />
              </div>
