          ...
          {betMode === "auto" && (
            <>
              ...
              <button
                ...
                className={`order-2 my-4 mt-6 md:mt-5 md:order-20 transition-all duration-300 ease-in-out transform active:scale-90 text-black ${
                  autoStart
                    ? "bg-gray-600 cursor-not-allowed"
                    : "bg-button-primary cursor-pointer"
                } flex items-center justify-center w-full py-3 max-lg:mt-1 rounded text-lg font-semibold`}
              >
